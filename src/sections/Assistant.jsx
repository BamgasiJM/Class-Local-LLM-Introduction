      ...
      <div className="container">
        ...
        <div className="grid grid-2">
          <Timeline items={[
            ...
            { title: '2. 시스템 프롬프트 작성', desc: '"너는 컴퓨터그래픽 수업의 조교다. 학생 눈높이로 친절히 설명한다" 식으로 역할을 고정.' },
            { title: '3. 강의자료 연결(RAG)', desc: '강의노트·교안 PDF를 업로드해 내 커리큘럼에 근거한 답변 유도.' },
            { title: '4. 커스텀 봇으로 저장', desc: 'Open WebUI의 Model 기능으로 "수업 조교" 봇을 저장해 재사용.' },
            { title: '5. 학생과 공유', desc: '다중 사용자 계정을 열어 강의실에서 함께 사용.' },
          ]} />
          <div>
            <Callout icon={Bot} title="예시 시스템 프롬프트" teal>
              "당신은 'AI로 빚는 아트워크' 과목의 AI 조교입니다. 업로드된 강의자료에 근거해 답하고, 출처가 없으면
              추측하지 말고 '자료에 없다'고 말합니다. 전문 용어는 영어 원어를 병기하고, 한국어로 친절하게
              단계별로 설명합니다."
            </Callout>
            <div className="mt1">
              <Callout icon={Bot} title="활용 아이디어">
                강의 Q&A 봇, 과제 피드백 보조, 코드 설명(p5.js·Three.js), 논문 요약, 알고리즘 용어 정리 등 —
